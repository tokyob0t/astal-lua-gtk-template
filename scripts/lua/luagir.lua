...
__modules["handlers.prop"] = function(...)
...
__modules["handlers.enum"] = function(...)
    local Enumeration = {}
...
__modules["handlers.method"] = function(...)
    local helpers = require('helpers')
    local Method = {}
...
__modules["handlers.const"] = function(...)
    local helpers = require('helpers')
    local Const = {}
    Const.__index = Const
...
__modules["xmlhandler.tree"] = function(...)
    local function init()
        local obj = {
            root = {},
            options = {noreduce = {}}
...
__modules["handlers.bitfields"] = function(...)
    local helpers = require('helpers')
    local Bitfield = {}
...
__modules["handlers.class"] = function(...)
    local helpers = require('helpers')
    local Class = {}
    Class.__index = Class
